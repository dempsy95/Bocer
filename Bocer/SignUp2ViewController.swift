...
class SignUp2ViewController: UIViewController, UITextFieldDelegate {
    ...
    */
    private func enterPerformed() {
        Alamofire.request(
            URL(string: "http://ec2-50-18-202-224.us-west-1.compute.amazonaws.com:3000/addUser")!,
            method: .post,
            ...
            .responseJSON {response in
                ...
                if(json["Target Action"] == "signupresult"){
                    if(json["content"] == "fail"){
                        ...
                        Alamofire.request(
                            URL(string: "http://ec2-50-18-202-224.us-west-1.compute.amazonaws.com:3000/login")!,
                            method: .post,
