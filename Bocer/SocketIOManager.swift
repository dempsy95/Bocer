...
class SocketIOManager: NSObject {
    ...
    var socket = SocketIOClient(socketURL: URL(string: "http://ec2-50-18-202-224.us-west-1.compute.amazonaws.com:8080")!, config: [.log(false), .forcePolling(true), .connectParams(["email" : UserInfoHelper().loadData().id!])])
