...
class EditAddressViewController: UIViewController, UITextViewDelegate {
    ...
    private func onMakeNavitem(){
        ...
        btn.addTarget(self, action: #selector(EditAddressViewController.didCancel), for: .touchUpInside)
        ...
        rightBtn.addTarget(self, action: #selector(EditAddressViewController.didFinish), for: .touchUpInside)
    ...
    @objc private func didFinish() {
        UserInfoHelper().saveAddress(name: mTextView.text)
        self.navigationController?.popViewController(animated: true)
    }
